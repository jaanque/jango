        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <nav className="hidden items-center gap-2 md:flex">
              <Link href="#how-it-works" className="text-sm font-medium text-slate-600 transition-colors hover:text-slate-900 px-3 py-2 rounded-md hover:bg-slate-100">Cómo Funciona</Link>
              <Link href="#pricing" className="text-sm font-medium text-slate-600 transition-colors hover:text-slate-900 px-3 py-2 rounded-md hover:bg-slate-100">Planes</Link>
              <Link href="#faq" className="text-sm font-medium text-slate-600 transition-colors hover:text-slate-900 px-3 py-2 rounded-md hover:bg-slate-100">FAQs</Link>
            </nav>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="#pricing" className="hidden sm:block rounded-md px-4 py-2 text-sm font-semibold text-slate-900 border border-slate-300 hover:bg-slate-100 transition-colors">Únete a la Liga</Link>
            <button
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-slate-200">
          <nav className="flex flex-col items-start gap-4 p-6">
            ...
            <Link href="#pricing" className="w-full text-center rounded-md px-4 py-3 text-base font-semibold text-slate-900 border border-slate-300 hover:bg-slate-100 transition-colors" onClick={() => setIsOpen(false)}>Únete a la Liga</Link>
          </nav>
        </div>
      )}
    </header>
